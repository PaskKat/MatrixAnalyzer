...
# Purpose: 
Independently recreate common linear algebra tools in python to understand how scipy.linalg works
# How it's Made: 
This repo uses no imported libraries (as a challenge) to understand how scipy operates. Only python's most basic functions are used.
...
# Functionality: PublicMatrixAnalyzer.py 
